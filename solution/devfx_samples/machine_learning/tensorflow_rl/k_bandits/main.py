...
from devfx_samples.machine_learning.tensorflow_rl.k_bandits.environment import Environment
from devfx_samples.machine_learning.tensorflow_rl.k_bandits.agent import Agent
...
agent.perform_next_action(action)