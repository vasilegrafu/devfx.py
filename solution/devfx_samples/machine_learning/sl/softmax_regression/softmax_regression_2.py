...
"""------------------------------------------------------------------------------------------------
"""
class SoftmaxRegression2Model(ml.sl.Model):
    # ----------------------------------------------------------------
    ...
    def h(self, x):
        ...
        """
        w = ml.sl.create_or_get_variable(name='w', shape=(4, 2), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        b = ml.sl.create_or_get_variable(name='b', shape=(4,), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
