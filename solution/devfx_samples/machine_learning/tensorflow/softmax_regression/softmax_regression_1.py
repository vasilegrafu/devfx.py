...
class SoftmaxRegression1Model(ml.Model):
    ...
    def h(self, x):
        w10 = ml.create_or_get_variable(name='w10', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w11 = ml.create_or_get_variable(name='w11', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w12 = ml.create_or_get_variable(name='w12', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        z1 = w10 + w11*x[:, 0] + w12*x[:, 1]

        w20 = ml.create_or_get_variable(name='w20', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w21 = ml.create_or_get_variable(name='w21', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w22 = ml.create_or_get_variable(name='w22', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        z2 = w20 + w21*x[:, 0] + w22*x[:, 1]

        w30 = ml.create_or_get_variable(name='w30', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w31 = ml.create_or_get_variable(name='w31', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w32 = ml.create_or_get_variable(name='w32', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        z3 = w30 + w31*x[:, 0] + w32*x[:, 1]

        w40 = ml.create_or_get_variable(name='w40', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w41 = ml.create_or_get_variable(name='w41', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w42 = ml.create_or_get_variable(name='w42', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
