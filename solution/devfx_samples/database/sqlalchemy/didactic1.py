...
entity1 = db.Table('entity1', database_metadata,
                    db.Column_as__id(db.types.Integer(), autoincrement=True),
...
""" Deploy
"""
db.deploy_database_metadata(database_metadata=database_metadata, connection_string=connection_string)
