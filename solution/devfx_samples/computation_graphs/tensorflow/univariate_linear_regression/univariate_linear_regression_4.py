...
class UnivariateLinearRegressionModel(cg.models.ImperativeModel):
    ...
    def _on_append_to_training_log(self, training_log, context):
        training_log.last_item.training_data_cost = self.run_cost_function(context.training_data[0], context.training_data[1])
        ...
        training_log.last_item.test_data_cost = self.run_cost_function(context.test_data[0], context.test_data[1])
...
chart.scatter(test_dataset[0], model.run_hypothesis_function(test_dataset[0]), color='red')
figure.show()
