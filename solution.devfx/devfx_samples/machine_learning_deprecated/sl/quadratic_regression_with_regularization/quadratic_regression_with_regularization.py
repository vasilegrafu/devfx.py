...
"""------------------------------------------------------------------------------------------------
"""
class uadraticRegressionWithRegularizatioModel(ml.sl.Model):
    # ----------------------------------------------------------------
    ...
    def h(self, x):
        ...
        w2 = ml.sl.create_or_get_variable(name='w2', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w3 = ml.sl.create_or_get_variable(name='w3', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
    ...
    def J(self, x, y):
        hr = self.h(x)
        w2 = ml.sl.get_variable(name='w2')
        w3 = ml.sl.get_variable(name='w3')
