...
"""------------------------------------------------------------------------------------------------
"""
class SoftmaxRegression1Model(ml.sl.Model):
    # ----------------------------------------------------------------
    # @ml.build_graph(x=(ml.float32, (None, 2)))
    @ml.output_as_tensor((ml.float32, (None, 4)))
    @ml.input_as_tensor(x=(ml.float32, (None, 2)))
    def h(self, x):
        w10 = ml.sl.create_or_get_variable(name='w10', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w11 = ml.sl.create_or_get_variable(name='w11', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w12 = ml.sl.create_or_get_variable(name='w12', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        z1 = w10 + w11*x[:, 0] + w12*x[:, 1]

        w20 = ml.sl.create_or_get_variable(name='w20', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w21 = ml.sl.create_or_get_variable(name='w21', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w22 = ml.sl.create_or_get_variable(name='w22', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        z2 = w20 + w21*x[:, 0] + w22*x[:, 1]

        w30 = ml.sl.create_or_get_variable(name='w30', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w31 = ml.sl.create_or_get_variable(name='w31', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w32 = ml.sl.create_or_get_variable(name='w32', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        z3 = w30 + w31*x[:, 0] + w32*x[:, 1]

        w40 = ml.sl.create_or_get_variable(name='w40', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w41 = ml.sl.create_or_get_variable(name='w41', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
        w42 = ml.sl.create_or_get_variable(name='w42', shape=(), dtype=ml.float32, initializer=ml.random_truncated_normal_initializer())
