...
def Column_as_StringPrimaryKey(length=1024, convert_unicode=True):
    return Column(sa.types.String(length=length, convert_unicode=convert_unicode), primary_key=True)

def Column_as_TextPrimaryKey(length=1024, convert_unicode=True):
    return Column(sa.types.String(length=length, convert_unicode=convert_unicode), primary_key=True)
    

def Column_as_DatePrimaryKey():
    return Column(sa.types.Date(), primary_key=True)

def Column_as_DateTimePrimaryKey():
    return Column(sa.types.DateTime(), primary_key=True)

def Column_as_TimePrimaryKey():
    return Column(sa.types.Time(), primary_key=True)

def Column_as_TimedeltaPrimaryKey():
    return Column(sa.types.Interval(), primary_key=True)
...
def Column_as__DateTime_id():
    return Column(sa.types.DateTime(), primary_key=True)

def Column_as__Time_id():
    return Column(sa.types.Time(), primary_key=True)

def Column_as__Timedelta_id():
    return Column(sa.types.Interval(), primary_key=True)
